...
def export_configuration():
    ...
    if not os.path.exists("block/_config.py"):
        ...
        template = textwrap.dedent('''\
            ...
            configuration metadata easily avaiable from `block/`
            ...
            ''')
        args = {
            key: metadata[value].__repr__() for key, value in dict(
                name='name', version='version', author='author',
                email='author_email', description='description'
                ).items()
            }
